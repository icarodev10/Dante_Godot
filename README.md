...
* **Orientação a Objetos (Herança):** Criação de uma classe base de `Inimigo` e derivação para monstros com comportamentos diferentes (Fantasmas lentos, Diabinhos rápidos e o Boss com alto HP).
